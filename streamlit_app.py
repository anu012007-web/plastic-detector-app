...
# CONFIG & INIT
# ==========================================
st.set_page_config(page_title="EcoScanIndia", page_icon="🌿", layout="wide")
...
# ==========================================
from translations_complete import LANGUAGES
...
# UI COMPONENTS
# ==========================================
st.sidebar.selectbox(t("select_lang"), list(LANGUAGES.keys()), key="lang")
st.sidebar.markdown("---")
...
<div class="hero-banner">
    ...
    <div style="margin-top: 15px; font-size: 1.2rem; font-weight: bold; color: var(--deep-blue);">{t('swachh_msg')}</div>
</div>
""", unsafe_allow_html=True)
...
with tab1:
    ...
    mode = col_mode.radio(t("detect"), [t("simple_mode"), t("detailed_mode")])
...
st.markdown("---")
st.markdown("<div style='text-align: center; color: gray;'>Powered by EcoScanIndia AI</div>", unsafe_allow_html=True)
